...
class PinsController extends AbstractController
{
    ...
    */
    public function show(Pin $pin, VolunteerRepository $volunteerRepository, TaskRepository $taskRepository): Response
    {
        $volunteers = $volunteerRepository->findBy(['pin' => $pin]);
        $nbrTaskEnded = count($taskRepository->findBy(['isEnded' => true, 'Pin' => $pin]));
